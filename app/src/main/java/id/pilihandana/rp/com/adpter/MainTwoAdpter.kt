...
class MainTwoAdpter : BaseQuickAdapter<MainModle?, BaseViewHolder>(R.layout.main_two_item) {
    ...
    override fun convert(helper: BaseViewHolder, item: MainModle?) {
        ...
        (helper.getView<TextView>(R.id.money)).setText("Rp "+item!!.priceMin+" ~ "+"Re "+item!!.priceMax)
